...
const initApp = () => {
    ...
    edit.addEventListener("submit", e => {
        ...
        crud.methods
            ...
            .catch(() => {
                editResult.innerHTML = 'Ooops... there was an error while trying to update user ${id} to ${name}.';
            });
    });
    ...
    del.addEventListener("submit", e => {
        ...
        crud.methods
            ...
            .then(() => {
                delResult.innerHTML = 'Deleted user ${id}';
            })
            .catch(() => {
                delResult.innerHTML = 'Ooops... there was an error while trying to delete user ${id}.';
            });
    });
